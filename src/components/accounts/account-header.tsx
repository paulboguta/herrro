    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between">
          <p className="text-muted-foreground text-sm">Created on {new Date(account.createdAt).toLocaleDateString()}</p>
          <p className="font-bold text-2xl">{formatCurrency(Number.parseFloat(account.balance), account.currency)}</p>
        </div>
      </div>
    </div>
  );
