  ...
  return (
    <Card className="@container/card bg-sidebar dark:bg-sidebar">
      <CardHeader>
        ...
        <CardDescription>
          <span className="@[540px]/card:block hidden">Cash and investments over time</span>
          ...
          <AreaChart data={filteredData}>
            <defs>
              ...
              <linearGradient id="fillInvestments" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="95%" stopColor="var(--color-investments)" stopOpacity={0.1} />
              </linearGradient>
            </defs>
            ...
            />
            <Area dataKey="cash" type="natural" fill="url(#fillCash)" stroke="var(--color-cash)" />
            <Area dataKey="investments" type="natural" fill="url(#fillInvestments)" stroke="var(--color-investments)" />
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
