...
export const accountCategoryEnum = pgEnum("account_category", ["asset", "liability"]);
...
export const accounts = pgTable("accounts", {
  ...
  startingBalance: decimal("starting_balance", { precision: 19, scale: 4 }).notNull().default("0"),
  balanceVersion: bigint("balance_version", { mode: "number" }).notNull().default(0),
